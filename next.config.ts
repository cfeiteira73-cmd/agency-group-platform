...
const securityHeaders = [
  ...
  // Content Security Policy — define exactamente de onde podem vir scripts, imagens, fonts
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.anthropic.com https://api.resend.com https://graph.facebook.com https://o4511156597096448.ingest.de.sentry.io https://api.stability.ai https://api.notion.com https://vercel.live wss://vercel.live https://www.wixapis.com https://accounts.google.com https://api.heygen.com https://production-sfo.browserless.io https://www.idealista.pt https://api.twilio.com https://region1.google-analytics.com https://www.google-analytics.com",
