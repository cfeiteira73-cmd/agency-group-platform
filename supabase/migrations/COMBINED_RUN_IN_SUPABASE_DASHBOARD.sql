...
-- =============================================================================
-- MIGRATION 017 — Data Quality Engine
-- Run date: 2026-04-13
-- =============================================================================
...
COMMENT ON COLUMN offmarket_leads.high_quality_lead_flag IS
  'TRUE quando lead tem dados completos:
   cidade + tipo_ativo + price_ask + area_m2 + score + buyer_match + price_intel.
