...
export const PROPERTIES: Property[] = [
  ...
  // COMPORTA
  { id:'AG-2026-030', ref:'AG-2026-030', nome:'Herdade Comporta Exclusiva', zona:'Comporta', bairro:'Comporta', tipo:'Herdade', preco:6500000, area:850, quartos:6, casasBanho:6, andar:'r/c', energia:'B', vista:'natureza', piscina:true, garagem:true, jardim:true, terraco:true, condominio:false, badge:'Off-Market', status:'Ativo', desc:'Herdade exclusiva na Comporta com 5 hectares de natureza preservada, arrozais e pinhais centenários. Arquitectura de autor em madeira e pedra natural. Piscina infinita com vista para o Sado.', features:['5 hectares natureza','Piscina infinita vista Sado','Arquitectura de autor','Materiais naturais premium','Acesso privado praia','Zona equestre possível'], tourUrl:null, grad:'135deg, #2a1e0a, #150f03', lat:38.3836, lng:-8.7628, lifestyle:['nature','equestrian','seafront'], videoUrl:'https://www.youtube.com/embed/dQw4w9WgXcQ', virtualTourEmbed:null },
