...
export const metadata: Metadata = {
  ...
  robots: 'index, follow',
  alternates: { canonical: 'https://agencygroup.pt/blog/buying-property-portugal-2026' },
  openGraph: {
    ...
    type: 'article',
    url: 'https://agencygroup.pt/blog/buying-property-portugal-2026',
    locale: 'en_US',
  },
}
    ...
    <>
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .loc-name{font-family:'Cormorant',serif;font-size:1.2rem;font-weight:300;color:#1c4a35;margin-bottom:8px}
        .loc-price{font-family:'DM Mono',monospace;font-size:.7rem;letter-spacing:.1em;color:#c9a96e;margin-bottom:6px}
