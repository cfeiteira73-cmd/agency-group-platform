    ...
    <>
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .art-cat{display:inline-block;background:rgba(201,169,110,.12);color:#c9a96e;font-family:'DM Mono',monospace;font-size:.46rem;letter-spacing:.2em;text-transform:uppercase;padding:5px 12px;margin-bottom:20px;border:1px solid rgba(201,169,110,.25)}
        ...
        .formula-label{font-family:'DM Mono',monospace;font-size:.48rem;letter-spacing:.2em;text-transform:uppercase;color:#1c4a35;margin-bottom:12px}
        .formula{font-family:'Cormorant',serif;font-size:1.2rem;font-weight:300;color:#0c1f15;line-height:1.6}
        .example-block{background:#fff;border:1px solid rgba(14,14,13,.1);padding:32px;margin:28px 0}
        .example-title{font-family:'DM Mono',monospace;font-size:.5rem;letter-spacing:.2em;text-transform:uppercase;color:#c9a96e;margin-bottom:16px}
        ...
        .tip-icon{font-family:'Cormorant',serif;font-size:1.5rem;font-weight:300;color:#c9a96e;margin-bottom:8px}
        .tip-title{font-family:'Jost',sans-serif;font-weight:500;font-size:.8rem;letter-spacing:.08em;text-transform:uppercase;color:#1c4a35;margin-bottom:8px}
      ...
      <footer style={{ background: '#0c1f15', padding: '40px 56px', borderTop: '1px solid rgba(201,169,110,.12)' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
            <Link href="/blog" style={{ fontFamily: "'DM Mono',monospace", fontSize: '.48rem', letterSpacing: '.16em', textTransform: 'uppercase', color: 'rgba(244,240,230,.35)', textDecoration: 'none' }}>Blog</Link>
            <Link href="/en" style={{ fontFamily: "'DM Mono',monospace", fontSize: '.48rem', letterSpacing: '.16em', textTransform: 'uppercase', color: 'rgba(244,240,230,.35)', textDecoration: 'none' }}>Properties</Link>
            <Link href="/blog/buying-property-portugal-2026" style={{ fontFamily: "'DM Mono',monospace", fontSize: '.48rem', letterSpacing: '.16em', textTransform: 'uppercase', color: 'rgba(244,240,230,.35)', textDecoration: 'none' }}>Buyer&apos;s Guide</Link>
            <Link href="/blog/taxes-imt-portugal-2026" style={{ fontFamily: "'DM Mono',monospace", fontSize: '.48rem', letterSpacing: '.16em', textTransform: 'uppercase', color: 'rgba(244,240,230,.35)', textDecoration: 'none' }}>IMT &amp; Taxes</Link>
          </div>
          <span style={{ fontFamily: "'DM Mono',monospace", fontSize: '.45rem', letterSpacing: '.12em', color: 'rgba(244,240,230,.2)' }}>© 2026 Agency Group · AMI 22506</span>
        </div>
      </footer>
    </>
  )
