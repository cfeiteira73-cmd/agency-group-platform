...
export const metadata: Metadata = {
  title: 'IMT and Property Taxes in Portugal 2026: What Foreign Buyers Must Know · Agency Group',
  ...
  robots: 'index, follow',
  alternates: { canonical: 'https://agencygroup.pt/blog/taxes-imt-portugal-2026' },
  openGraph: {
    ...
    type: 'article',
    url: 'https://agencygroup.pt/blog/taxes-imt-portugal-2026',
    locale: 'en_US',
  },
}
    ...
    <>
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .art-cat{display:inline-block;background:rgba(201,169,110,.15);color:#c9a96e;font-family:'DM Mono',monospace;font-size:.46rem;letter-spacing:.2em;text-transform:uppercase;padding:5px 12px;margin-bottom:20px;border:1px solid rgba(201,169,110,.3)}
        ...
        .tax-card-name{font-family:'DM Mono',monospace;font-size:.5rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(14,14,13,.4);margin-bottom:8px}
        .tax-card-rate{font-family:'Cormorant',serif;font-size:1.8rem;font-weight:300;color:#1c4a35;margin-bottom:8px}
      ...
      <footer style={{ background: '#0c1f15', padding: '40px 56px', borderTop: '1px solid rgba(201,169,110,.12)' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
            ...
            <Link href="/blog/capital-gains-property-portugal-2026" style={{ fontFamily: "'DM Mono',monospace", fontSize: '.48rem', letterSpacing: '.16em', textTransform: 'uppercase', color: 'rgba(244,240,230,.35)', textDecoration: 'none' }}>Capital Gains</Link>
          </div>
