...
export default function AITimelineError({
  error,
  reset,
}: {
  ...
  useEffect(() => { console.error('[CT/ai-timeline]', error) }, [error])

  return (
    <div className="flex flex-col items-center justify-center min-h-[40vh] gap-4">
      <div className="bg-[#111118] border border-red-800/40 rounded-lg p-6 max-w-md w-full text-center space-y-3">
        <div className="text-2xl">🕐</div>
        <p className="text-red-400 text-sm font-medium">AI Timeline failed to load</p>
