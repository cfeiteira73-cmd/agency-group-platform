...
const COMMANDS: Command[] = [
  ...
  // Ferramentas
  { id: 'tool-mortgage',    label: 'Simulador Crédito',    description: 'TAN · TAEG · Euribor · Amortização',   category: 'Ferramentas', section: 'credito',     icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 11h.01M12 11h.01M15 11h.01M4 19h16a2 2 0 002-2V7a2 2 0 00-2-2H4a2 2 0 00-2 2v10a2 2 0 002 2z' },
