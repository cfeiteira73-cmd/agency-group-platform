...
<div class="footer">
  ...
  return (
    <>
      ...
      <div style={{display:'flex',flexDirection:'row',height:'100vh',overflow:'hidden'}} className="portal-main">
        ...
        {/* ═══════════ MAIN ═══════════ */}
        <div style={{flex:1,minWidth:0,display:'flex',flexDirection:'column',overflow:'hidden',background:'#f4f0e6'}}>

          {/* HEADER — só título + stats */}
          <header style={{height:'56px',background:'#f4f0e6',borderBottom:'1px solid rgba(14,14,13,.08)',display:'flex',alignItems:'center',justifyContent:'space-between',padding:'0 16px 0 20px',flexShrink:0}}>
...
Agency Group · AMI 22506 · geral@agencygroup.pt`}
            ...
            {section==='portfolio' && (
              <div style={{maxWidth:'900px'}}>
                <div style={{fontFamily:"'DM Mono',monospace",fontSize:'.5rem',letterSpacing:'.2em',textTransform:'uppercase',color:'rgba(14,14,13,.35)',marginBottom:'8px'}}>Score 16D · Ranking automático</div>
                <div style={{fontFamily:"'Cormorant',serif",fontWeight:300,fontSize:'1.8rem',color:'#0e0e0d',marginBottom:'24px'}}>Comparação <em style={{color:'#1c4a35'}}>Portfolio</em></div>
                <div className="p-card" style={{marginBottom:'16px'}}>
